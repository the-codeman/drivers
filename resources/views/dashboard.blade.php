...
@section('main')
{{ @Auth::user()->name}} {{ __('Driver Dashboard') }} 
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div class="profile-userpic">
                                                <img src="../../assets/img/driver.jpg" class="img-responsive" alt=""> </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="profile-desc">
                                            Aenean eget ultrices mi, eget interdum tortor. Aenean eget imperdiet nulla. Vestibulum venenatis eu ipsum et faucibus. Fusce venenatis lobortis nisi, sit amet fringilla risus vehicula non. Quisque vel rutrum lacus.
                                        </div>
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                <b>Gender </b>
				                            ...
				                            <div class="tab-content">
				                                <div class="tab-pane active fontawesome-demo" id="tab1">
														<div id="biography" >
						                                    ...
						                                    <hr>
						                                    <p class="m-t-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque varius luctus accumsan. Nunc vulputate, mi eget faucibus pulvinar, arcu metus mattis lectus, id commodo purus justo non turpis.</p>
						                                    <p>Aenean eget ultrices mi, eget interdum tortor. Aenean eget imperdiet nulla. Vestibulum venenatis eu ipsum et faucibus. Fusce venenatis lobortis nisi, sit amet fringilla risus vehicula non. Quisque vel rutrum lacus. </p>
						                                    ...
						                                    <hr>
						                                    	<div class="row">
							                                      ...
							                                      <div class="col-md-9">534534634</div>
							                                  	</div>
							                                  	<div class="row">
							                                      <div class="col-md-3">Cab Type:</div>
							                                      <div class="col-md-9">SUV</div>
							                                  	</div>
							                                  	<div class="row">
